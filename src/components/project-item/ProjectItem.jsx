...
export default function ProjectItem({project}) {
    ...
    for(var key in trMap) {
        project.projectType = project.projectType.replace(new RegExp('['+key+']','g'), trMap[key])
        ...
        <div className={`item-container ${project.projectType}`}>
            <div className="project-item" style={{scale: 0}} ref={projectItem}>
                ...
                <div className="top">
                    ...
                    <div className="links">
                        <a href={project.projectDesign} className="link-item">
                        ...
                        {project.projectStatus == 'Tamamlandı' ? (
                            <a href={project.projectWebsite} className="link-item">
