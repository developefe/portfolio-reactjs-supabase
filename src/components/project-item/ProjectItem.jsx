...
export default function ProjectItem({project}) {
    ...
    return(
        <div className={`item-container ${project.projectType +' '+ project.projectName.toLowerCase()}`}>
            <div className="project-item" style={{scale: 0}} ref={projectItem}>
                ...
                <div className="top">
                    ...
                    <div className="links">
                        <a href={project.projectDesign === null || project.projectDesign == '' ? '#!' : project.projectDesign} className="link-item">
                        ...
                        {project.projectStatus === 'Tamamlandı' ? (
                            <a href={project.projectWebsite === null || project.projectWebsite =='' ? '#!' : project.projectWebsite} className="link-item">
