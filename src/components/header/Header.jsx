...
export default function Header({...props}) {
    ...
    const toggleLang = () => {
        ...
        localStorage.setItem('lang', isTR ? "en" : "tr");
        navigate(isTR ? "/en" : "/tr");
    };
        ...
        <div className={`header ${isScrolled ? 'fixed-active' : ''}`}>
            <div className="header-container">
                ...
                <div className="lang-and-soc">
                    ...
                    <div className="lang" style={{color: 'white', cursor: 'pointer'}} onClick={() => toggleLang()}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24.909" height="24.909" viewBox="0 0 24.909 24.909">
                            <path class="a" stroke='none' d="M10.089,13.624a.365.365,0,0,0-.365-.365H1.535a.806.806,0,0,1-.805-.805V1.535A.806.806,0,0,1,1.535.73h10.92a.806.806,0,0,1,.805.805v8.19a.365.365,0,0,0,.73,0V1.535A1.537,1.537,0,0,0,12.454,0H1.535A1.537,1.537,0,0,0,0,1.535v10.92a1.537,1.537,0,0,0,1.535,1.535h8.19A.365.365,0,0,0,10.089,13.624Z"></path>
                            <path class="b" stroke='none' d="M236.906,224.452h-3.12a.365.365,0,0,0,0,.73h3.12a.806.806,0,0,1,.805.805v10.919a.806.806,0,0,1-.805.805H225.987a.806.806,0,0,1-.805-.805V225.987a.806.806,0,0,1,.805-.805h6.24a.365.365,0,0,0,0-.73h-6.24a1.537,1.537,0,0,0-1.535,1.535v10.919a1.537,1.537,0,0,0,1.535,1.535h10.919a1.537,1.537,0,0,0,1.535-1.535V225.987A1.537,1.537,0,0,0,236.906,224.452Z" transform="translate(-213.532 -213.532)"></path>
                            <path class="a" stroke='none' d="M71.514,64.909H68.369v-.415a.365.365,0,0,0-.73,0v.415H64.494a.365.365,0,1,0,0,.73h5.373A10.182,10.182,0,0,1,68,69.033a10.271,10.271,0,0,1-1.465-2.351.365.365,0,1,0-.666.3,11,11,0,0,0,1.639,2.6A9.871,9.871,0,0,1,65.476,71.2a.365.365,0,1,0,.375.626,10.616,10.616,0,0,0,2.15-1.7,10.632,10.632,0,0,0,2.154,1.7.365.365,0,1,0,.375-.626,9.9,9.9,0,0,1-2.037-1.618,10.97,10.97,0,0,0,1.294-1.893,10.127,10.127,0,0,0,.841-2.05h.885a.365.365,0,1,0,0-.73Z" transform="translate(-61.009 -61.009)"></path>
                            <path class="b" stroke='none' d="M307.4,288.9a.522.522,0,0,0-.485-.325h0a.522.522,0,0,0-.484.326l0,.008-2.636,6.921a.365.365,0,1,0,.682.26l.567-1.489h3.731l.561,1.488a.365.365,0,0,0,.683-.258l-2.612-6.921Zm-2.082,4.971,1.6-4.191,1.582,4.191Z" transform="translate(-288.985 -274.541)"></path>
                            <path class="a" stroke='none' d="M93.831,309.76l-1.56-1.17a.365.365,0,0,0-.438.584l.684.513H91.272a2.368,2.368,0,0,1-2.365-2.365v-2.34a.365.365,0,0,0-.73,0v2.34a3.1,3.1,0,0,0,3.095,3.095h1.245l-.684.513a.365.365,0,0,0,.438.584l1.56-1.17a.365.365,0,0,0,0-.584Z" transform="translate(-83.887 -289.797)"></path>
                            <path class="b" stroke='none' d="M304.759,65.955l1.56,1.17a.365.365,0,0,0,.438-.584l-.684-.513h1.245a2.368,2.368,0,0,1,2.365,2.365v2.34a.365.365,0,0,0,.73,0v-2.34a3.1,3.1,0,0,0-3.095-3.095h-1.245l.684-.513a.365.365,0,1,0-.438-.584l-1.56,1.17a.365.365,0,0,0,0,.584Z" transform="translate(-289.794 -61.009)"></path>
                        </svg>
                    </div>
                </div>
            </div>
