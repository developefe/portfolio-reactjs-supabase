...
export default function Header() {
    ...
    const buttonClick = () => {
        $('.header .social .left').toggleClass('active');
        $('.header .social .right').toggleClass('active');
        $('.header .social .left').addClass('pointer-none');
        setTimeout(() => {
            $('.header .social .left').removeClass('pointer-none');
        }, 700);
    }
        ...
        <div className={`header ${isScrolled ? 'fixed-active' : ''}`}>
            <div className="header-container">
                ...
                <div className="social">
                    <div className="left" onClick={buttonClick}>
